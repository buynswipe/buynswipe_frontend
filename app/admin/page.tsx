...
export default async function AdminPage() {
  ...
  return <main>
    ...
    <div className="mt-8 grid gap-4 sm:grid-cols-3"><Metric label="New leads" value={leads ?? 0} detail="Needs triage" /><Metric label="Audit events" value={auditEvents ?? 0} detail="Recorded actions" /><Metric label="Access role" value={staff?.role.replaceAll("_", " ") || "staff"} detail="Current permissions" /></div>
